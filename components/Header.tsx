...
export default function Header() {
  return (
    <nav className="fixed z-40 flex h-28 w-full bg-light bg-transparent filter backdrop-blur-sm transition-all duration-75 ease-linear dark:bg-transparent dark:bg-dark xl:bg-light/90">
