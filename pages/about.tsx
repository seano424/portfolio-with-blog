...
export default function About() {
  return (
    <>
      <Head>
        <title>About Me | Sean O'Reilly</title>
        <meta
          name="description"
      ...
      <div className="pl-base lg:pl-auto py-base container grid gap-5 text-lg leading-loose dark:text-white xl:max-w-3xl">
        ...
        <p>
          ...
          smooth website that run blazingly fast.
        </p>
        <p>
          I’m currently working as a front-end developer at TrendyMinds where I
          help develop websites that combine powerful functionality with
          intuitive design to give clients the best user experience. We mainly
          work with Craft CMS, the LAMP stack, React (Next JS), and Tailwind
          CSS.
        </p>
        <p>
          ...
          During my free-time I love being outdoors or dabbling with photography
          - scuba diving, hiking, going to the beach, or going skiing are some
          of my favorite adventurous activities. And I also love reading science
          fiction and keeping up with various publications about the newest
          technology trends and other programming languages. You can find me on{' '}
          <a
